...
/**
* com/abc/AuctionApp/_AuctionServerStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Auction.idl
* Thursday, February 23, 2017 6:53:15 PM CST
*/

public class _AuctionServerStub extends org.omg.CORBA.portable.ObjectImpl implements com.abc.AuctionApp.AuctionServer
{
  ...
  public String offerItem (String id, com.abc.AuctionApp.Item item)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("offerItem", true);
                $out.write_string (id);
                com.abc.AuctionApp.ItemHelper.write ($out, item);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
